  ...
  const modules = [
    {
      ...
      data: {
        ...
        description:
          "OopsyInk turns your child into the hero of their very own illustrated storybook — built around their name, their personality, and the adventures they dream about.",
...

    {
      ...
      data: {
        ...
        subtitle:
          "From a few little details to a keepsake they'll pull off the shelf for years — here's how it comes together.",
        steps: [
          {
            id: "tellUs",
            icon: "🌟",
            ...
            description:
              "Share their name, a photo, age, and the little personality traits that make them who they are.",
          },
          {
            id: "weWrite",
            icon: "✍️",
            ...
            description:
              "Our story magic writes and illustrates a one-of-a-kind tale with your child as the hero.",
          },
          {
            id: "keepsake",
            icon: "📦",
            ...
            description:
              "Read it instantly online, and revisit it any time — a keepsake made just for them.",
          },
        ],
      },
    },

    {
      ...
      data: {
        ...
        subtitle:
          "Children who see themselves in stories build deeper confidence, richer imagination, and a lasting love of reading.",
        ...
        features: [
          {
            ...
            description:
              "Seeing themselves as the brave hero of their own adventure helps kids believe in themselves too.",
          },
          {
            id: "keepsake",
            icon: "💖",
            ...
            description:
              "Not a toy they'll outgrow — a story with their name on it, ready to revisit for years to come.",
          },
          {
            id: "craft",
            icon: "🖌️",
            ...
            description:
              "Every tale is thoughtfully written and illustrated around your child's own personality and interests.",
          },
        ],
      },
    },

    {
      ...
      data: {
        ...
        subtitle:
          "Every book is handcrafted around your child — blending a real photo with a hand-picked story world.",
        ...
        steps: [
          {
            ...
            description:
              "Share their name, age, a few personality traits, and a couple of clear photos to begin the magic.",
          },
          {
            id: "likeness",
            number: 2,
            ...
            description:
              "We carefully recreate your child's features and weave them into a consistent storybook character across every page.",
          },
          {
            id: "world",
            number: 3,
            ...
            description:
              "Choose from magical worlds — dinosaurs, space, the beach, and more — each one written fresh around your child.",
          },
          {
            id: "written",
            number: 4,
            ...
            description:
              "Our story engine writes a one-of-a-kind adventure and illustrates it page by page, just for them.",
          },
          {
            id: "preview",
            number: 5,
            ...
            description:
              "Read the cover and first page for free — no payment needed until you love what you see.",
          },
          {
            id: "keepsake",
            number: 6,
            ...
            description:
              "Dive in online right away, and add a printed hardcover keepsake at checkout if you'd like one shipped home.",
          },
        ],
      },
    },
...

    {
      ...
      data: {
        ...
        subtitle:
          "Give your child the gift of seeing themselves as the hero. A story made only for them, treasured for a lifetime.",
        cta: "Begin Their Story",
        cta_url: "/personalize",
      },
    },

    {
      ...
      data: {
        ...
        subtitle:
          "New story worlds, features, and the occasional offer — no spam, just magic.",
